...
**Note:** `e - rowMeans(e)` is the most efficient method because it leverages R's column-major matrix storage and vectorized subtraction, avoiding the overhead of `apply` or multiple transpositions.
